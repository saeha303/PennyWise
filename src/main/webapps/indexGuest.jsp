  ...
  <body class="index-page">
    <%@ include file="navbarGuest.jsp" %>
      <main class="main">
            ...
            <div class="row gy-4">
              <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <div class="d-flex flex-column flex-md-row" data-aos="fade-up" data-aos-delay="200">
                  <a href="#services" class="btn-get-started">Get Started <i class="bi bi-arrow-right"></i></a>
        ...
        <!-- services Section -->
        <section id="services" class="values section">

          <!-- Section Title -->
          <div class="container section-title" data-aos="fade-up">
            <h2>Our Services</h2>
            <p>What We Offer<br></p>
        ...
        <!-- Advantage Section -->
        <section id="advantage" class="features section">

          <!-- Section Title -->
          <div class="container section-title" data-aos="fade-up">
            <h2>Your Bendfits</h2>
            <p>What's Yout Catch<br></p>
          </div><!-- End Section Title -->
        ...
        <section id="demo" class="services section">
