                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTab"
                                                            ...
                                                            <li class="nav-item justify-content-between align-items-center" role="presentation">
                                                                <button class="nav-link active" id="home-tab"
                                                                    ...
                                                                    aria-selected="true"><span
                                                                        class="badge square-pill bg-primary p-2 ms-2"><i
                                                            ...
                                                            <li class="nav-item" role="presentation">
                                                                <button class="nav-link" id="profile-tab"
                                                                    data-bs-toggle="tab"
                                                                    data-bs-target="#bordered-profile" type="button"
                                                            ...
                                                            <li class="nav-item" role="presentation">
                                                                <button class="nav-link" id="contact-tab"
                                                                    data-bs-toggle="tab"
                                                                    data-bs-target="#bordered-contact" type="button"
                                                                    role="tab" aria-controls="contact"
                                                                    aria-selected="false" tabindex="-1"><span
                                                                        class="badge square-pill bg-primary p-2 ms-2"><i
                                                                            class="ri-filter-line"></i></span>
                                                                    Filter</button>
                                                            </li>
                                                        ...
                                                        <div class="tab-content pt-2" id="borderedTabContent">
                                                            ...
                                                            <div class="tab-pane fade" id="bordered-contact"
